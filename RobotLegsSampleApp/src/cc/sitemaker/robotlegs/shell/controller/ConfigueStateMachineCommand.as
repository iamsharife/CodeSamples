package cc.sitemaker.robotlegs.shell.controller
{
	...
	import cc.sitemaker.robotlegs.shell.controller.state.GlobalTagsEnteringCommand;
	import cc.sitemaker.robotlegs.shell.controller.state.LoadModuleCommand;
	import cc.sitemaker.robotlegs.shell.controller.state.NonModularEnteringCommand;
	import cc.sitemaker.robotlegs.shell.controller.state.PostTagsEnteringCommand;
	...
	public class ConfigueStateMachineCommand extends Command
	{
		override public function execute():void
		{
			...
			commandMap.mapEvent( FSMModularDemo.POST_TAGS_ENTERING, PostTagsEnteringCommand,Object );
			commandMap.mapEvent( FSMModularDemo.GLOBAL_TAGS_ENTERING, GlobalTagsEnteringCommand,Object );
			commandMap.mapEvent( FSMModularDemo.NON_MODULAR_ENTERING, NonModularEnteringCommand,Object );
